...
class Grid():
    ...
    def visualize(self, is_display=True, is_save=False):
        ...
        cmap = colors.ListedColormap(['#262626', '#2C2C2C'])
        im = plt.imshow(self._grid, interpolation='none', cmap=cmap)
...
if __name__ == '__main__':
    rule = rb.Rules32trit.rule1864467387_32bit
    ...
    g.visualize(is_display=True, is_save=True)
